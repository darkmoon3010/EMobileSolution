...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="main-data" id="divGridView" runat="server">
        <asp:GridView ID="grvListUser" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Height="183px" AutoGenerateColumns="False" Width="341px" OnRowCommand="grvListUser_RowCommand" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="Sửa">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("UserId") %>' CommandName="_edit" Height="25px" ImageUrl="~/images/icon/PinClipart.com_microsoft-clipart-online_1646319.png" Width="20px" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Xoá">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnDelete" runat="server" CommandArgument='<%# Eval("UserId") %>' CommandName="_delete" Height="23px" ImageUrl="~/images/icon/PinClipart.com_trash-clipart_5787306.png" Width="20px" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
