            ...
            <asp:GridView ID="grvListProduct" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Height="183px" AutoGenerateColumns="False" Width="295px" OnRowCommand="grvListProduct_RowCommand" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sửa">
                        <ItemTemplate>
                            <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("ProductId") %>' CommandName="_edit" Height="25px" ImageUrl="~/images/icon/edit.png" Width="25px" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Xoá">
                        <ItemTemplate>
                            <asp:ImageButton ID="btnDelete" runat="server" CommandArgument='<%# Eval("ProductId") %>' CommandName="_delete" Height="23px" ImageUrl="~/images/icon/trash.png" Width="25px"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <div id="divContentDetail" runat="server">
                 <table style="width: 60%; border-collapse: collapse; border-style: solid; border-width: 1px">
                     ...
                     <tr>
                        ...
                        <td style="width: 462px">      
                        <asp:Button ssClass="btn bg-danger" ID="btnGoBack" runat="server" Text="Trở về" OnClick="btnGoBack_Click"/>
                        </td>
                     </tr>
                </table>
            </div>
